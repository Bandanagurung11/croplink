...
--
-- Host: 127.0.0.1
-- Generation Time: Aug 31, 2023 at 03:44 PM
...
INSERT INTO `buyerregistration` (`buyer_id`, `buyer_name`, `buyer_phone`, `buyer_addr`, `buyer_store`, `buyer_mail`, `buyer_username`, `buyer_password`, `buyer_bank`) VALUES
(19, 'ansh', 9819104641, 'fam', '', 'abhi@hmil.com', 'ansh', 'y5CB', ''),
(20, 'bhabalomkar421', 8828071232, 'bj', '', 'xyz@domain.com', '501807', 'yw==', ''),
(21, 'raj gurung', 34567, 'dhading', 'dhading', 'raj@gmail.com', 'raju', 'iMPY', 'akjdb'),
(22, 'ram gurung', 1234, 'dhading', 'ramja', 'ram@gmail.com', 'ramu', 'iMPf', '273h'),
(23, 'rahul gurung', 145, 'dhading', 'rahu', 'rahul@gmail.com', 'rahul', 'iMPa++Q=', 'jad6');
...
CREATE TABLE `farmerregistration` (
  ...
  `farmer_province` int(100) NOT NULL,
  `farmer_district` varchar(50) NOT NULL,
  `farmer_username` varchar(600) NOT NULL,
  `farmer_password` varchar(100) NOT NULL,
  `farmer_bank` varchar(5000) NOT NULL,
  `farmer_strname` varchar(500) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1 COLLATE=latin1_swedish_ci;
...
INSERT INTO `farmerregistration` (`farmer_id`, `farmer_name`, `farmer_phone`, `farmer_address`, `farmer_province`, `farmer_district`, `farmer_username`, `farmer_password`, `farmer_bank`, `farmer_strname`) VALUES
(91, 'Jasmeet', 8169193187, 'Manchester city', 0, 'Kachchh', '', 'yw==', '', ''),
(92, 'bhabalomkar421', 8828071232, '1', 0, 'Sheopur *', '', 'yw==', '', ''),
(93, 'rabi gurung', 8910, 'dhading', 3, 'dhading', 'rabi', 'iMPQ5w==', 'ajfb3', 'rabu'),
(94, 'namu gurung', 1120, 'dhading', 3, 'dhading', 'namu', 'lMPf+w==', 'amb8', 'namru'),
(95, 'ganu gurung', 567, 'dhading', 3, 'dhading', 'ganu', 'ncPc+w==', 'ajhd3', 'ganus');
